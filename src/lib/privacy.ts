...
export const PRIVACY_BODY = [
  ...
  "Porters scan and close walks on this device with no account. A secure dealership workspace (email and password) is only for managers who need Pro, extra lots, or team logins. Walk archives still stay on this device.",
